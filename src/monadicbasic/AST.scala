...
case class DefStatement(varName: String, typeName: String, arraySize: Option[Expression], pos: Pos) extends Statement

case class PrintStatement(e: Expression) extends Statement

case class InputStatement(name: String, pos: Pos) extends Statement

case class AssigmentStatement(name: String, index: Option[Expression], e: Expression, pos: Pos) extends Statement

case class ForStatement(body: Statement, name: String, bounds: (Expression, Expression), pos: Pos) extends Statement

case class IfStatement(codition: Expression, body: Statement, alt: Option[Statement], pos: Pos) extends Statement

case class WhileStatement(codition: Expression, body: Statement, pos: Pos) extends Statement
