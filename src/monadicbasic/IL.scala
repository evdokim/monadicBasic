...
case class ArrayDefOp(varName: String, typeInfo: TypeInfo, size: Expression, pos: Pos) extends Op

case class VarDefOp(varName: String, typeInfo: TypeInfo) extends Op
...
case class AssigmentArrayOp(name: String, index: Expression, expr: Expression, pos: Pos) extends Op
